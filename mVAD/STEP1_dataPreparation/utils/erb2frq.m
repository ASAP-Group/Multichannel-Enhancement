...
%
%    Note that erb values will be clipped to 43.which corresponds to infinite frequency.
%    The inverse function is frq2erb.

%   The erb scale is measured using the notched-noise method [3].
%
%    We have df/de = 6.23*f^+ 93.39*f + 28.52
...
%
%    where p and q are the roots of the equation: -0.and -14.7
%      and d = (6.23*(p-q))/= 0.08950404
%
%    from this we can derive:
%
%    f = k/(h-exp(d*e)) + c
%
%    where k = q (- q/p) = 676170.4
%          h = q/p = 47.06538
%          c = 1000q = -14678.49
%    and f is in Hz
%
% Note that the maximum permissible value of e is log(b)/c=43.since this gives f=inf
%
%    References:
%
...
%      Version: $Id: erb2frq.m 2015-03-16:01:14Z dmb $
%
...
if ~numel(u)
    u=[6.23e-93.39e-28.52];
    p=sort(roots(u));           % p=[-14678.-311.9]
